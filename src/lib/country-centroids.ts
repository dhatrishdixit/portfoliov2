...
// ISO 3166-1 alpha-2 country code -> [latitude, longitude]
// Source: Google public data (CC-BY 4.0), based on ISO 3166-1 alpha-2 codes.
export const CENTROIDS: Record<string, [number, number]> = {
  ...
  GS: [-54.429579, -36.587909],// South Georgia and South Sandwich Islands
